...
DESTINATION_BASE_DIR="/backups/$CURRENT_HOST" # Path to your remote backup directory
...
# Perform the backup
ssh -o BatchMode=yes -o ConnectTimeout=5 "ubuntu-vm" "mkdir -p $DESTINATION_BASE_DIR" 2>&1 | tee -a "$LOG_FILE"
